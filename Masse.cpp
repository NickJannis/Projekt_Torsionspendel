...
<<<<<<< HEAD
void Masse::setRai(const double& pRai, const double& pFehler){
	rai.clear();
	rai.push_back(pRai);
...
<<<<<<< HEAD
void Masse::setRaa(const double& pRaa, const double& pFehler){
	raa.clear();
	raa.push_back(pRaa);
...
<<<<<<< HEAD
void Masse::setLaen(const double& pLaen, const double& pFehler){
	laen.clear();
